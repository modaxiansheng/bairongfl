...
@import 'var.less';
// color
@primary-color: @br-default-color;
@success-color: @br-success-color;
@warning-color: @br-warn-color;
@error-color: @br-error-color;
...
// Background color
@table-thead-bg               : #F0F1F5;

@menu-dark-title              : #323844;
/*@menu-dark-active-bg          : #232730;*/
